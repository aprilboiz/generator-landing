      ...
      <Container>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10">
            ...
            <div>
              <h3 className="font-bold text-lg mb-1">Bảo hành dài hạn</h3>
          ...
          <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10">
            ...
            <div>
              <h3 className="font-bold text-lg mb-1">Phản hồi nhanh chóng</h3>
              <p className="text-gray-400 text-sm">
          ...
          <div className="flex items-start gap-4 p-5 rounded-xl bg-white/5 border border-white/10">
            ...
            <div>
              <h3 className="font-bold text-lg mb-1">Giá cả minh bạch</h3>
              <p className="text-gray-400 text-sm">
