...
export function HeroSection() {
  return (
    <section
      id="hero"
      className="relative min-h-[90vh] flex items-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 overflow-hidden"
    >
      {/* Background Pattern */}
      ...
      {/* Hero Image */}
      <div className="absolute right-0 top-0 w-full lg:w-1/2 h-full opacity-30 lg:opacity-50">
        <Image
          src="/generator-hero.jpg"
      ...
      <Container className="relative z-10 py-20">
        <div className="max-w-3xl">
          ...
          {/* Trust Indicators */}
          <div className="mt-12 flex flex-wrap items-center gap-8 text-gray-400">
